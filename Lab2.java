...
public class Lab2 {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("( is treated the same as {. And ) is the same as }. Since there is no difference in mathematics.");
   ...
   if (s.equals("exit")) {
    ...
    while ((!(s.equals("solve"))) && itemCounter < 50) { // while the user is inputting something that is not solve
      ...
      if (lastWasNumber == false) {
        System.out.println("Use one of the following: Positive Number, -, +, /, *, ^, (, ), {, }      type and enter 'solve' when ready (without the 's)");
